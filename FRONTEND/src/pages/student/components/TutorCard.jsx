...
function TutorCard({ tutor }) {
  ...
  d="m62.76 36.94c4.24 8.74 10.71 10.21 16.09 10.21h5"></path>
    ...
    opacity: .1
      ...
      <circle r="3" fill="#515570" cy="62.28" cx="76"></circle><circle r="3" fill="#515570" cy="62.28" cx="52"></circle>
      ...
      <path strokeWidth="2" stroke="#515570" opacity=".2" d="m82 56h-9.25"></path></g>
